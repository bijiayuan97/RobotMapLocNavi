...
(cl:defmethod cl:initialize-instance :after ((m <MyServiceMessage-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MyServiceMessage-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name localization-srv:<MyServiceMessage-request> is deprecated: use localization-srv:MyServiceMessage-request instead.")))

(cl:ensure-generic-function 'label-val :lambda-list '(m))
(cl:defmethod label-val ((m <MyServiceMessage-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localization-srv:label-val is deprecated.  Use localization-srv:label instead.")
  (label m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MyServiceMessage-request>)))
  ...
  "localization/MyServiceMessageRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MyServiceMessage-request)))
  "Returns string type for a service object of type 'MyServiceMessage-request"
  "localization/MyServiceMessageRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <MyServiceMessage-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MyServiceMessage-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name localization-srv:<MyServiceMessage-response> is deprecated: use localization-srv:MyServiceMessage-response instead.")))
...
(cl:defmethod navigation_successfull-val ((m <MyServiceMessage-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localization-srv:navigation_successfull-val is deprecated.  Use localization-srv:navigation_successfull instead.")
  (navigation_successfull m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <MyServiceMessage-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localization-srv:message-val is deprecated.  Use localization-srv:message instead.")
  (message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MyServiceMessage-response>)))
  ...
  "localization/MyServiceMessageResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MyServiceMessage-response)))
  "Returns string type for a service object of type 'MyServiceMessage-response"
  "localization/MyServiceMessageResponse")

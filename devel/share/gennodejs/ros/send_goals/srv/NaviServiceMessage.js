...
class NaviServiceMessageRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type NaviServiceMessageRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type NaviServiceMessageRequest
    let len;
    let data = new NaviServiceMessageRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new NaviServiceMessageRequest(null);
...
class NaviServiceMessageResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type NaviServiceMessageResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type NaviServiceMessageResponse
    let len;
    let data = new NaviServiceMessageResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new NaviServiceMessageResponse(null);
...
module.exports = {
  Request: NaviServiceMessageRequest,
  Response: NaviServiceMessageResponse,
  md5sum() { return '920ca5ca095e1b5230fc32da338a974c'; },
  datatype() { return 'send_goals/NaviServiceMessage'; }
};

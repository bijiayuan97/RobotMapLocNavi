...
get_filename_component(_filename "/home/jiayuanbi/catkin_ws/src/pp_msgs/srv/PathPlanningPlugin.srv" NAME_WE)
add_custom_target(_pp_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "pp_msgs" "/home/jiayuanbi/catkin_ws/src/pp_msgs/srv/PathPlanningPlugin.srv" ""
)
...
_generate_srv_cpp(pp_msgs
  "/home/jiayuanbi/catkin_ws/src/pp_msgs/srv/PathPlanningPlugin.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/pp_msgs)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/pp_msgs\")")
  # install generated code
  install(
